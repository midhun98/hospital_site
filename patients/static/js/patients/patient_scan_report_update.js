    ...
    function populateForm() {
        ...
        for (const image of scanImages) {
            ...
            if (imageIsPDF(fileExtension)) {
                ...
                fileContent = `<a href="${imageUrl}" target="_blank">
                                <figure><img class="img-fluid img-thumbnail" src="${imageUrl}" alt="Scan Image" style="width: 200px; height: 200px"></figure>${fileName}
                            </a>`;
            } else {
                fileContent = `<a href="${imageUrl}" target="_blank"><figure><img class="img-fluid img-thumbnail" src="https://res.cloudinary.com/dbzcqkvnj/image/upload/v1692944606/rodeo.jpg" style="width: 200px; height: 200px"></figure>${fileName}</a>`;
            }
