...
urlpatterns = [
    ...
    path("patient/<int:patient_id>/patient-invoice/<int:invoice_id>/update/",
         TemplateView.as_view(template_name="invoices/patient_invoice_update.html"), name='patient-invoice-update'),
